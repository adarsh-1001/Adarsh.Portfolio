    ...
    <section id="hire-me" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            Let's bring your ideas to life! I'm available for freelance
            projects, full-time positions, and consulting opportunities.
          </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          >
              ...
              <CardContent className="p-8">
                ...
                <ul className="space-y-4 mb-8 text-blue-100">
                  <li className="flex items-start">
                    ...
                    <span>
                      Proven track record of delivering high-quality, scalable
                      solutions
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      Strong technical skills with experience in modern web
                      technologies
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      Commitment to ongoing learning and staying current with
                      industry trends
                    </span>
                  </li>
                </ul>
                  ...
                  >
                    <a href="#contact">
                      ...
                      >
                        ...
                        <span
                          className="absolute -inset-0.5 rounded-full bg-gradient-to-r from-pink-500 to-pink-600 opacity-0 
                          group-hover:opacity-30 blur-md transition-all duration-300"
                        ></span>
                      </button>
                    </a>
                  </motion.div>
            ...
            >
              <div
                className="bg-gradient-to-r from-blue-900/60 to-blue-800/60 backdrop-blur-sm p-6 rounded-xl
                border-l-4 border-pink-500 shadow-lg transform hover:-translate-y-1 transition-transform duration-300"
              >
                <p className="text-blue-100 italic">
                  "Adarshs is a highly skilled developer who consistently
                  delivers exceptional results. His technical expertise and
                  problem-solving abilities make him an invaluable asset to any
                  project."
                </p>
                ...
                {/* Decorative elements */}
                <div className="absolute top-2 right-2 text-pink-500/20 text-5xl font-serif">
                  "
                </div>
              </div>
            </motion.div>
